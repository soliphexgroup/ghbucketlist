import { BedDouble, HeartHandshake, Compass, Car, Wrench, type LucideIcon } from "lucide-react";

export type ServiceTabId = "stays" | "date-experiences" | "things-to-do" | "car-rentals" | "handyman";
...
export const serviceTabs: ServiceTab[] = [
  ...
  { id: "date-experiences", label: "Date Experiences", icon: HeartHandshake, href: "/date-experiences" },
...
export function getActiveServiceTab(pathname: string): ServiceTabId | null {
  ...
  if (pathname.startsWith("/date-experiences")) return "date-experiences";
...
export const PAGES_WITH_OWN_HERO = ["/", "/cars", "/activities", "/date-experiences", "/services"];
